...
This creates tool-specific skill links or instruction files so each assistant finds the project guidance in its expected location:
...
Patterns tailored for Juanchito assistant workflows and reusable project operations:

| Skill | Description |
|-------|-------------|
| `engram-context-sync` | Coordinate Engram context across machines |
| `documentation-writer` | Write project documentation with Diataxis structure |
| `create-readme` | Create or improve repository README files |
| `guardiania-smart-commit` | Prepare conventional commits from real diffs |
| `dependency-supply-chain-security` | Review dependency and package install risk |
| `workstation-install-safety` | Check local workstation safety before installs or moves |
...
- [Project AGENTS.md](../AGENTS.md) - AI agent general rules
